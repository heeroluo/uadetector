...
exports.otherRules = [
  ...
  { name: '华为', keywords: ['IdeaHub'] },
  { name: 'vivo', keywords: ['vivo', 'VivoBrowser'] },
  { name: 'OPPO', keywords: ['oppo'] },
  { name: '小米', keywords: ['redmi', 'hongmi', 'xiaomi', 'XiaoMi', 'shark', 'Mi'] },
  ...
  { name: '华为', modelRule: /^(?:CHE|CHM|Che1|VIE|BND|PAR|JKM|EML|OXF|VOG|JSN|VCE|STK|STF|BZT|YAL|INE|COR|SPN|AGS2|MAR|LYA|BKL|CLT|SEA|MHA|EVR|VKY|ANE|ALP|TIT|MRX|ELE|DVC|SCM|JLH|JDN2|JEF|Hera|Hebe|FIO|ELZ|MNT|LRA)-/ },
  { name: '华为', modelRule: /^TYH\d+[A-Z]$/ },
  { name: '华为', rule: /\bLiantongVP\d{3}\b/},
