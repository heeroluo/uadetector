...
exports.otherRules = [
  ...
  { name: '小米', keywords: ['redmi', 'hongmi', 'shark', 'Mi', 'MIX', 'POCO', 'POCOPHONE'] },
  ...
  { name: '联想', keywords: ['lenovo', 'zuk', 'erazer', 'Lecoo'] },
  ...
  { name: '酷派', modelRegExp: /^CPD[A-Z0-9]{3}$/ },
