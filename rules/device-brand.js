...
exports.otherRules = [
  ...
  { name: '诺基亚/Lumia', keywords: ['lumia'] },
  { name: '诺基亚', regExp: /\bnokia/i },
  { name: '摩托罗拉', keywords: ['motorola', 'moto'] },
  { name: '索尼', regExp: /\bsony/i },
  { name: '索尼', keywords: ['xperia'] },
  ...
  { name: '小米', modelRegExp: /^(?:AWM|SKR|SKW|DLT|AGS5Z)-/ },
  { name: '小米', modelRegExp: /^XIG\d{2}$/ },
  { name: '小米', modelRegExp: /^M\d{4}[A-Z]\d{1,2}[A-Z]{1,3}$/ },
  ...
  { name: '金立', modelRegExp: /^GNP?\d{2}[A-Z]\d{2}$/ },
  ...
  { name: '小辣椒', modelRegExp: /^LJU[DT]?\d{4}$/ },
  { name: '优学派', modelRegExp: /^YXP\b/ },
  { name: '快易典', modelRegExp: /^KYD-/ },
  { name: '夏新', modelRegExp: /^AMOI\d{4}$/ },
  { name: '天语', modelRegExp: /^LD(OX|XA|XD)-\d{4}$/ },
  { name: '天语', modelRegExp: /^LD20\d{5}$/ },
  { name: '天语', modelRegExp: /^KT\d{6,8}$/ },
  { name: '纽曼', modelRegExp: /^N[MW]20\d{5}$/ },
  { name: '学而思', modelRegExp: /^TALIH-/ },
  { name: '作业帮', modelRegExp: /^ZPD\d{4}$/ },
  ...
  { name: '酷派', modelRegExp: /^CP\d{1,2}[A-Z]{2}\d$/ },
  { name: '酷派', modelRegExp: /^CP\d[A-Z]{4}$/ },
